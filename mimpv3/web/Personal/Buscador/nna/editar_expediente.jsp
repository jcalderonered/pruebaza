                            ...
                            <c:if test="${expediente != null}">
                                ...
                                <fieldset>
                                    ...
                                    <div class="control-group">
                                        ...
                                        <div class="controls">
                                            <input  id="ht" name="ht" onkeyup="return(limitar());" value="${expediente.getHt()}" type="text" class="input-xlarge">
                                        </div>
                                    </div>                                                                    
                                    <br>
                                    <div class="control-group">
                                    ...
                                    <div class="control-group">
                                        ...
                                        <div class="controls">
                                            <textarea id="diagnostico" name="diagnostico" onkeyup="return(limitar());" onkeyup="return(limitar());" type="text" class="input-xlarge">${expediente.getDiagnostico()}</textarea>
                                        </div>
                                    </div>
                                    <br>
                                    <div class="control-group">
