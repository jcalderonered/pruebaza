            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-md-6 col-md-offset-1">
                        <p align="right"><button onclick="location.href = '${pageContext.servletContext.contextPath}/editarNna2?idNna=${nna.getIdnna()}'" id="singlebutton" name="singlebutton" style="background: black; color: white" class="btn btn-default">Volver</button></p> 
                        <h1 align="center"><strong>Expediente del NNA</strong></h1>
                        <br>
                        <c:if test="${expediente == null}">
                            <form class="form-horizontal" action="${pageContext.servletContext.contextPath}/crearExpedienteNna2" method="post">
                                <input hidden name="idNna" id="idNna" value="${nna.getIdnna()}">  
                               </c:if>  
                                  <c:if test="${expediente != null}">
                                       <form class="form-horizontal" action="${pageContext.servletContext.contextPath}/updateExpedienteNna2" method="post">
