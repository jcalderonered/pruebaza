            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-md-6 col-md-offset-1">
                        <p align="right"><button onclick="location.href = '${pageContext.servletContext.contextPath}/buscarNna'" id="singlebutton" name="singlebutton" style="background: black; color: white" class="btn btn-default">Volver</button></p>  
                        ...
                        <c:if test="${nna == null}">
                            ...
                            <fieldset>
                                ...
                                <div class="control-group">
                                    ...
                                    <div class="controls">
                                        <input id="apellidoP" onkeyup="return(limitar());" value="${nna.getApellidoP()}" name="apellidoP" type="text" class="input-xlarge">
                                    </div>
                                </div>
                                <br>
                                <div class="control-group">
                                    ...
                                    <div class="controls">
                                        <input id="apellidoM" onkeyup="return(limitar());" value="${nna.getApellidoM()}" name="apellidoM" type="text" class="input-xlarge">
                                    </div>
                                </div>
                                <br>
                                <div class="control-group">
                                ...
                                <br>        
                                       <c:if test="${nna.getExpedienteNnas().isEmpty()}">
                                         <form class="form-horizontal" action="${pageContext.servletContext.contextPath}/agregarExpedienteNna2" method="post"> 
                                             <input hidden name="idNna" id="idNna" value="${nna.getIdnna()}">   
                                            </c:if>  
                                                <c:if test="${!nna.getExpedienteNnas().isEmpty()}">
