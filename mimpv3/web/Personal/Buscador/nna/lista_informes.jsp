                    ...
                    <div class="col-md-6 col-md-offset-1">
                        ...
                        <div class="table-responsive">
                            <table id="mi_tabla" class="table table-bordered table-striped">
                                <thead>
                                    <tr>
                                        <th class="col-sm-2 " >Número de informe</th>
                                        <th class="col-sm-2 " >Fecha</th>
                                        <th class="col-sm-2 " >Editar</th>
                                    </tr>
                                </thead>
                                <c:if test="${!listaInformes.isEmpty()}">
                                    <tbody>
                                        <c:forEach var="informe" items="${listaInformes}" varStatus="status">
                                            <tr>
                                                <td>${informe.getNumero()}</td>
                                                <td>${informe.getFecha() != null ? df.dateToStringNumeros(informe.getFecha()) :''}</td>
                                                <td>
                                                    <form action="${pageContext.servletContext.contextPath}/NnaEditarInforme" method="post">
                                ...
                                <c:if test="${listaInformes.isEmpty()}">
                                    <h3><strong>No existen informes registrados</strong></h3>
                                </c:if> 
                            </table>
                        </div>
                        <br>
                        <div class="control-group">
                            <form action="${pageContext.servletContext.contextPath}/NnaAgregarInforme" method="post">
                                <input hidden name="clasificacion" id="clasificacion" value="${clasificacion}">
                                <input hidden name="idExpNna" id="idExpNna" value="${idExpNna}">
                                <button class="btn btn-default">Registrar nuevo informe</button> 
                            </form>
                        </div>
