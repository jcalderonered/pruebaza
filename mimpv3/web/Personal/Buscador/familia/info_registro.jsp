                    ...
                    <div class="col-md-8">
                        ...
                        <form role="form" action="${pageContext.servletContext.contextPath}/ActualizarRegistro" method="post">
                            ...
                            <ul class="nav nav-tabs row">
                                ...
                                <li ${estado == 'formativa' ? 'class="hidden"' : 'class="active"'} ><a href="${pageContext.servletContext.contextPath}/infoExpediente2?volver=${volver}&expediente=${expediente2}&HT=${HT}&nacionalidad=${nacionalidad}&estado=${estado2}&tipofamilia=${tipofamilia}" >Información del Expediente</a></li>
