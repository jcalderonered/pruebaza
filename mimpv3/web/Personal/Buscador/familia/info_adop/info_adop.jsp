                ...
                <div class="row">
                    ...
                    <div class="col-md-8">
                        ...
                        <ul class="nav nav-tabs row">
                            ...
                            <li class="active"><a href="${pageContext.servletContext.contextPath}/procesoAdopcion2?volver=${volver}&expediente=${expediente2}&HT=${HT}&nacionalidad=${nacionalidad}&estado=${estado2}&tipofamilia=${tipofamilia}" >Proceso de adopción</a></li>
