                ...
                <div class="row">
                    ...
                    <div class="col-md-8">
                                    ...
                                    <tbody>
                                        <c:forEach var="atencion" items="${listaAtenciones}" varStatus="status">
                                            <tr>
                                                ...
                                                <td>
                                                    <form class="form-horizontal" action="${pageContext.servletContext.contextPath}/DetalleAtencion2" method="post">
                                                        <input hidden id="idAtencion" name="idAtencion" value="${atencion.getIdatencion()}">    

                                                        <input hidden name="volver" id="volver" value="/atenciones2">
                                                        <input hidden name="expediente" id="expediente" value="${expediente2}">
                                                        <input hidden name="HT" id="HT" value="${HT}">
                                                        <input hidden name="nacionalidad" id="nacionalidad" value="${nacionalidad}">
                                                        <input hidden name="estado" id="estado" value="${estado2}">
                        ...
                        <div class="control-group">
                            <div class="controls">
                                <button onclick="window.location.href = '${pageContext.servletContext.contextPath}/agregarAtencion2?volver=/atenciones2&expediente=${expediente2}&HT=${HT}&nacionalidad=${nacionalidad}&estado=${estado2}&tipofamilia=${tipofamilia}'" id="singlebutton" name="singlebutton" class="btn btn-default">Registrar nueva atención</button>
                            </div>
                        </div>
                        <!--FIN DE CONTENIDO-->
                    </div>
