                    ...
                    <div class="col-md-8">
                        ...
                        <form role="form" action="${pageContext.servletContext.contextPath}/ActualizarInfoFamilia" method="post" name="formulario" onsubmit="return(validar());">
                            ...
                            <ul class="nav nav-tabs row">
                                ...
                                <li ${estado == 'formativa' ? 'class="hidden"' : 'class="active"'} ><a href="${pageContext.servletContext.contextPath}/antNna2?volver=${volver}&expediente=${expediente2}&HT=${HT}&nacionalidad=${nacionalidad}&estado=${estado2}&tipofamilia=${tipofamilia}" >Antecedentes del NNA</a></li>
