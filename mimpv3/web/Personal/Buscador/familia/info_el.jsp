                    ...
                    <div class="col-md-8">
                        ...
                        <form role="form" action="${pageContext.servletContext.contextPath}/ActualizarAdoptante" method="post" name="formulario"> <!--onsubmit="return(validar());">-->
                            ...
                            <ul class="nav nav-tabs row">
                                ...
                                <li class="active"><a href="${pageContext.servletContext.contextPath}/elSolicitante2?volver=${volver}&expediente=${expediente2}&HT=${HT}&nacionalidad=${nacionalidad}&estado=${estado2}&tipofamilia=${tipofamilia}" >El solicitante</a></li>
