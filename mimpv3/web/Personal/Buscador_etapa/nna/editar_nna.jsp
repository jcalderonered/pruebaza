                            ...
                            <fieldset>
                                ...
                                <br>        
                                       <c:if test="${nna.getExpedienteNnas().isEmpty()}">
                                         <form class="form-horizontal" action="${pageContext.servletContext.contextPath}/agregarExpedienteNna3" method="post"> 
                                             <input hidden name="idNna" id="idNna" value="${nna.getIdnna()}"> 
                                             <input hidden name="volver" id="volver" value="${volver}">
                                             <input hidden name="volver2" id="volver2" value="${volver2}">
                                            </c:if>  
                                                <c:if test="${!nna.getExpedienteNnas().isEmpty()}">
                                                    <form class="form-horizontal" action="${pageContext.servletContext.contextPath}/editarExpedienteNna3" method="post">
                                                    <input hidden name="idNna" id="idNna" value="${nna.getIdnna()}">
                                                    <input hidden name="volver" id="volver" value="${volver}">
                                                    <input hidden name="volver2" id="volver2" value="${volver2}">
                                                </c:if>                                                   
