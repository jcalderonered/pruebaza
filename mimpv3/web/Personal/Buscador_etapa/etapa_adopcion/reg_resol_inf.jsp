                ...
                <div class="row">
                    ...
                    <div class="col-md-6 col-md-offset-1">
                        ...
                        <c:if test="${resolucion.getIdresolucion() == 0}">
                            <form class="form-horizontal" action="${pageContext.servletContext.contextPath}/crearResolInforme" method="post" name="formulario" onsubmit="return(validar());" onkeypress="return enter(event)"> 
