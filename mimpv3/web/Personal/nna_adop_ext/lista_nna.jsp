                ...
                <div class="row">
                    <div class="col-md-4 ">
                        <ul class="nav nav-list well">
                            ...
                            <%if (!u.getRol().equals("DEIA Prio") && !u.getRol().equals("DAPA")) {%>
                    ...
                    <div class="col-md-6 col-md-offset-1"> 
                        ...
                        <br>
                        <h1 align="center"><strong>Lista de NNA Adoptados</strong></h1>
                        <br>
                                ...
                                <tbody>
                                  <c:forEach var="desig" items="${listaDesig}" varStatus="status"> 
                                    <tr>
                                        ...
                                        <td>
                                            <form action="${pageContext.servletContext.contextPath}/MainEditarNna" method="post">
                                                <input hidden name="idDesig" id="idDesig" value="${desig.getIddesignacion()}">
                                                <input hidden name="idNna" id="idNna" value="${desig.getNna().getIdnna()}">
                                                <input hidden name="fechaAdopcion" id="fechaAdopcion" value="${desig.getFechaConsejo() != null ? df.dateToStringNumeros(desig.getFechaConsejo()) : ''}">
                                                <input hidden name="numAdopcion" id="numAdopcion" value="${desig.getNDesignacion()}">
