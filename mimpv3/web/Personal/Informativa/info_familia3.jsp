                ...
                <div class="row">
                    <div class="col-md-6 col-md-offset-1">
                        <c:if test="${idReunion != null}">
                            <form action="${pageContext.servletContext.contextPath}/PersonalTomaAsistencia?idReunion=${idReunion}&idTaller=${idTaller}&nombre=${nombre}&historial=${historial}&grupo=${grupo}&turno=${turno}" method="post">
