                        ...
                        <c:if test="${nna == null}">
                            ...
                            <fieldset>
                                ...
                                <div class="control-group">
                                    ...
                                    <div class="controls">
                                        <input id="nombre" name="nombre" value="${nna.getNombre()}" onkeyup="return(limitar());" type="text" class="input-xlarge">
                                    </div>
                                </div>
                                <br>
                                <div class="control-group">
                                    ...
                                    <div class="controls">
                                        <input id="apellidoP" value="${nna.getApellidoP()}" name="apellidoP" type="text" onkeyup="return(limitar());" class="input-xlarge">
                                    </div>
                                </div>
                                <br>
                                <div class="control-group">
                                    ...
                                    <div class="controls">
                                        <input id="apellidoM" value="${nna.getApellidoM()}" name="apellidoM" type="text" onkeyup="return(limitar());" class="input-xlarge">
                                    </div>
                                </div>
                                <br>
                                <div class="control-group">
                                ...
                                <div class="control-group">
                                    ...
                                    <br>
                                    <input id="direccion" name="direccion" type="text" value="${nna.getLugarNac()}" placeholder="Dirección" onkeyup="return(limitar());" class="input-xlarge">
                                </div>
                                <br>
                                <div class="control-group">
                                    <label class="control-label">Número de resolución de abandono</label>
                                    <div class="controls">
                                        <input id="numResolAband" name="numResolAband" value="${nna.getNResolAband()}" type="text" onkeyup="return(limitar());" class="input-xlarge">
                                    </div>
                                </div>
                                <br>
                                <div class="control-group">
                                ...
                                <div class="control-group">
                                    ...
                                    <div class="controls">
                                        <input id="numResolConsen" name="numResolConsen" value="${nna.getNResolCons()}" type="text" onkeyup="return(limitar());" class="input-xlarge">
                                    </div>
                                </div>
                                <br>
                                <div class="control-group">
                                ...
                                <br>        
                                       <c:if test="${nna.getExpedienteNnas().isEmpty()}">
                                         <form class="form-horizontal" action="${pageContext.servletContext.contextPath}/agregarExpedienteNna4" method="post"> 
                                             <input hidden name="idNna" id="idNna" value="${nna.getIdnna()}">   
                                            </c:if>  
                                                <c:if test="${!nna.getExpedienteNnas().isEmpty()}">
                                                    <form class="form-horizontal" action="${pageContext.servletContext.contextPath}/editarExpedienteNna4" method="post">
                                                    <input hidden name="idNna" id="idNna" value="${nna.getIdnna()}">    
                                                </c:if>                                                   
