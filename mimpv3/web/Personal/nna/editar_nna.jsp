                        ...
                        <c:if test="${nna == null}">
                            ...
                            <fieldset>
                                ...
                                <div class="control-group">
                                    ...
                                    <div class="controls">
                                        <input id="apellidoP" value="${nna.getApellidoP()}" onkeyup="return(limitar());" name="apellidoP" type="text" class="input-xlarge">
                                    </div>
                                </div>
                                <br>
                                <div class="control-group">
                                    ...
                                    <div class="controls">
                                        <input id="apellidoM" value="${nna.getApellidoM()}" onkeyup="return(limitar());" name="apellidoM" type="text" class="input-xlarge">
                                    </div>
                                </div>
                                <br>
                                <div class="control-group">
