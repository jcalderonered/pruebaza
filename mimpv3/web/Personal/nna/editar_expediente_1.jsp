                ...
                <div class="row">
                    ...
                    <div class="col-md-6 col-md-offset-1">
                        ...
                        <c:if test="${expediente == null}">
                            <form class="form-horizontal" action="${pageContext.servletContext.contextPath}/crearExpedienteNna4" method="post">
                                <input hidden name="idNna" id="idNna" value="${nna.getIdnna()}">  
                               </c:if>  
                                  <c:if test="${expediente != null}">
                                       <form class="form-horizontal" action="${pageContext.servletContext.contextPath}/updateExpedienteNna4" method="post">
