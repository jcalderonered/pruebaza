            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-md-6">
                        ...
                        <h1 align="center"><strong>Lista de Atenciones</strong></h1>
                        <br>
                        <div class="table-responsive">
                            <table class="table table-bordered table-striped">
                                <thead>
                                    <tr>
                                        <th class="col-sm-3">Personal</th>
                                        <th class="col-sm-2">Tipo de atención</th>   
                                ...
                                <tbody>
                                    <tr>
                                        <td>Luis Gamarra Ruiz</td>
                                        <td>Correo</td>
                                        <td>Aviso de resolución generada</td>
                                        <td>Sin inconvenientes</td>
                                        <td>
                                    ...
                                    <tr>
                                        <td>Ronald Cortez Lopez</td>
                                        <td>Teléfono</td>
                                        <td>Motivo de inasistencia a taller</td>
                       ...
                       <!-- Button -->
                                <div class="control-group">
                                    <div class="controls">
                                        <button id="singlebutton" name="singlebutton" class="btn btn-default">Nueva atención</button>
                                    </div>
                                </div>
                    </div>
                </div>
