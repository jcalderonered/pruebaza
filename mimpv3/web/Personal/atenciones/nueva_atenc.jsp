            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-md-6 col-md-offset-1">
                        ...
                        <h1 align="center"><strong>Editar Atención</strong></h1>
                        <br>
                                ...
                                <!-- Text input-->
                                    <div class="control-group">
                                           <label class="control-label">Tipo de atención</label>
                                            <div class="controls">
                                                <select>
                                                     <option value="sia">Teléfono</option>
                                                     <option value="mia">Correo</option>
                                                     <option value="mia">Documento</option>
                                                </select>
                                            </div>
                                    </div>
                                    <br>
                                    <div class="control-group">
                                        <label class="control-label">Detalle</label>
                                            <div class="controls">
                                                <textarea rows="3" cols="25" class="input-xlarge"></textarea>
                                            </div>
                                    </div>
                                    <br>
                                     <div class="control-group">
