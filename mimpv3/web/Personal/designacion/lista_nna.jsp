            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-md-6 col-md-offset-1">
                        ...
                        <h1 align="center"><strong>Lista de NNA </strong></h1>
                        <br>
                        <p><strong>
                            Lista de NNA's que coinciden con los antecedentes registrados por la familia en su ficha de solicitud de adopción
                            </strong></p>
                        <br>
                        ...
                        <br>
                              <div class="control-group">
                                    <div class="controls">
                                        <button id="singlebutton" name="singlebutton" class="btn btn-default">Designar NNA(s) seleccionado/s</button>
                                        &nbsp;
