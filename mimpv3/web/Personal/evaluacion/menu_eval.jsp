            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-md-6 col-md-offset-1">
                        ...
                        <h1 align="center"><strong>Evaluaciones del registro N°----</strong></h1>
                        <br>
                        
                        <div class="row">
                            <div class="col-md-2 col-md-offset-2">
                                <button id="singlebutton" name="singlebutton" class="btn btn-default">EVALUACIÓN PSICOSOCIAL</button>
                            </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-2 col-md-offset-2">
                                <button id="singlebutton" name="singlebutton" class="btn btn-default">EVALUACIÓN LEGAL</button>
                            </div>
                        </div>
