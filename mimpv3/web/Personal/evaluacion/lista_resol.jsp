            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-md-6">
                        ...
                        <h1 align="center"><strong>Lista de Resoluciones</strong></h1>
                        <br>
                            ...
                            <table class="table table-bordered table-striped">
                                <thead>
                                    <tr>
                                        ...
                                        <th class="col-sm-2">Fecha de resolución</th>   
                                        <th class="col-sm-2">Fecha de notificación</th>   
                       ...
                       <!-- Button -->
                                <div class="control-group">
                                    <div class="controls">
                                        <button id="singlebutton" name="singlebutton" class="btn btn-default">Nueva resolución</button>
                                    </div>
                                </div>
                    </div>
                </div>
