                        ...
                        <form class="form-horizontal"> 
                            <fieldset>
                                ...
                                <div class="control-group">
                                    ...
                                    <div class="controls">
                                        <input disabled id="full-name" name="full-name" value="11-06-13" type="text" class=" datepicker input-xlarge">
                                    </div>
                                </div>
                                <br>
                                <div class="control-group">
                                    ...
                                    <div class="controls">
                                        <textarea disabled class="input-xlarge" name="message" rows="5" >11-07-13 / 18-07-13 / 25-07-13 / 01-08-13 / 08-09-13</textarea>
                                    </div>
                                </div>     
                                <br>
