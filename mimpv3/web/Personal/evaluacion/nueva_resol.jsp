            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-md-6 col-md-offset-1">
                        ...
                        <h1 align="center"><strong>Editar Resolución</strong></h1>
                        <br>
                                ...
                                <!-- Text input-->
                                    ...
                                    <div class="control-group">
                                        <label class="control-label">Tipo</label>
                                            <div class="controls">
                                        <select  >
                                            <option value="sia">Observaciones</option>
                                            <option value="mia">Aptitud</option>
                                    ...
                                    <br>
                                     <div class="control-group">
                                         <label class="control-label">Fecha de notificación</label>
                                            <div class="controls">
                                              <input id="full-name" name="full-name" type="text" class="datepicker input-xlarge">
                                            </div>
                                    </div>
