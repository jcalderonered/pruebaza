            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-md-6 col-md-offset-1">
                        ...
                        <h1 align="center"><strong>Buscador de Registros</strong></h1>
                        <br>
                        <form class="form-horizontal">
                            <fieldset>
                                <!-- Text input-->
                                    ...
                                    <br>
                                    <div class="control-group">
                                         <label class="control-label">Número de resolución de adopción</label>
                                            <div class="controls">
                                              <input id="full-name" name="full-name" type="text" class="input-xlarge">
                                            </div>
                                    </div>                                    
                                    ...
                                    <div>
                                       <label class="control-label">Etapa</label>
                                         <div class="controls">
                                             <select>
                                                 <option value="sia">Formativa</option>
                                                 <option value="sia">Evaluación</option>
                                                 <option value="sia">Designación</option>
                                    ...
                                    <div>
                                       <label class="control-label">Estado</label>
                                         <div class="controls">
                                             <select>
                                                 <option value="sia">Evaluación</option>
                                                 <option value="sia">Observado</option>
                                                 <option value="sia">Culminado</option>
                                                 <option value="mia">Reevaluación</option>
                                                 <option value="sia">Apto</option>
                                                 <option value="sia">Fin de procedimiento</option>
                                                 <option value="sia">Improcedente</option>
                                             </select>
                                         </div>    
                                    </div>
                                    <br>
                                    <div>
                                         <label class="control-label">Resultado de evaluación psicosocial</label>
                                         <div class="controls">
                                             <select>
                                    ...
                                    <br>
                                    <div>
                                         <label class="control-label">Resultado de evaluación legal</label>
                                         <div class="controls">
                                             <select>
                                                 <option value="sia">Favorable</option>
                                                 <option value="sia">No favorable</option>
                                    ...
                                    <br>
                                    <div>
                                         <label class="control-label">Resultado de empatia</label>
                                         <div class="controls">
                                             <select>
                                                 <option value="sia">Favorable</option>
                                                 <option value="sia">No favorable</option>
                                    ...
                                    <br>
                                    <div>
                                         <label class="control-label">Resultado de colocación familiar</label>
                                         <div class="controls">
                                             <select>
                                                 <option value="sia">Favorable</option>
                                                 <option value="sia">No favorable</option>
                                    ...
                                    <br>
                                    <div>
                                         <label class="control-label">Resultado de adopción</label>
                                         <div class="controls">
                                             <select>
                                                 <option value="sia">Favorable</option>
                                                 <option value="sia">No favorable</option>
