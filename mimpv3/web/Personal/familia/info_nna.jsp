                ...
                <div class="row">
                    ...
                    <div class="col-md-8">
                        ...
                        <ul class="nav nav-tabs row">
                            ...
                            <li ${estado == 'formativa' || estado == 'evaluacion' || estado == 'espera' || estado == 'designacion' || estado == 'adopcion' || estado == 'reevaluacion' ? 'class="hidden"' : 'class="active"'} ><a href="${pageContext.servletContext.contextPath}/nnaAsociado?volver=${volver}" >NNA Adoptado</a></li>
